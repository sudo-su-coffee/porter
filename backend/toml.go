...
// subset avoids pulling in a TOML library the same way compose.go
// avoids a YAML one. Returns section name -> key -> raw value; the
// top-level (pre-section) keys live under the "" section.
